...
var sound = ABXY.base.Extend({
    ...
    /* Play the sound, and if cont is true, continue from where it last left
     * off */
    Play: function(cont) {
        if (!cont) {
             ...
             * don't allow seeking. Thus, we take the hit and reload the sound
             * file if seeking failed */
