ABXY.Math = (function() {
    ...
    var ABXYMath = {
        ...
        /* performs a linear interpolation of the first value to the second
         * value, with the third value as the amount of interpolation */
        lerp: function(from, to, l) {
            return (to - from) * l + from;
        },

        /* clamps the first value to a value between the second and third
         * values */
