...
var ABXY = {
    ...
    /*
     * Load all the dependent files of ABXY. Currently, just loads all of the
     * ABXY files. Maybe at some point, this will turn into a minified version
     * (thus removing the need to load the scripts seperately) or there will be
     * some sort of way of telling ABXY what dependencies are needed.
     */
...
ABXY.loader = {
    LoadDependencies: function(root, dependencies, callback) {
        ...
        var loaded = _.map(dependencies, function(d, script) {
            return this._LoadScript(script, dependencies, root, load_status);
        }, this);
    ...
    _LoadScript: function(script, dependencies, base, load_status) {
        ...
        var do_wait = function() {
            if (_.all(dependencies[script], function(d) {
                        return load_status[d] && load_status[d] === "loaded";
                    }, this)) {
                do_load();
            } else {
